    ...
    public void writeXls(ArrayList<DataFile> controller, ArrayList<MetaData> metaData, int name, String version) {
        try  {
            ...
            for (DataFile cList : controller){
                ...
                pb.step();
                pb.setExtraMessage("Запись");

            }

            ProgressBar pb1 = new ProgressBar("Расшифровка рег.статуса", 201);
